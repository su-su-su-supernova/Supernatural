...
namespace OculusXRHMD
{
	...
	void FOculusXRFunctionLibraryOpenXR::OvrpGetOpenXRInstanceProcAddrFunc(void** func)
	{
		ensureMsgf(false, TEXT("OvrpGetOpenXRInstanceProcAddrFunc is only available with OvrPlugin"));
	}
