...
public:
	...
	*/
	...
	/**
	Path to Synthetic Environment Server Directory
	*/
	UPROPERTY(config, EditAnywhere, Category = PC, meta = (DisplayName = "Meta XR Synthetic Environments.", ConfigRestartRequired = true))
	FDirectoryPath SynthEnvDirPath;
